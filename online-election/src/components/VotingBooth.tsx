              ...
              `}
                        ...
                        >
                            <div className="p-6 flex flex-col h-full items-center text-center">
                                ...
                                {/* Text Info */}
                                <h3 className="text-xl font-black text-[#003366] mb-1 uppercase tracking-tighter leading-tight">{party.name}</h3>
                                <div className={`px-4 py-1 rounded-full text-[10px] font-black uppercase tracking-[0.2em] mb-6 ${isSelected ? 'bg-white text-[#FF9933]' : 'bg-slate-100 text-[#003366]'}`}>
                                    Symbol: {party.symbol || "N/A"}
                                </div>
